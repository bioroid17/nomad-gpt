...
def embed_file(file):
    ...
    file_path = f"./.cache/privategpt/files/{file.name}"
    with open(file_path, "wb") as f:
        f.write(file_content)

    cache_dir = LocalFileStore(f"./.cache/privategpt/embeddings/{file.name}")
...
if file:
    ...
    pathname = f"./.cache/privategpt/memories/{file.name}/memory.json"
    ...
    if message:
        ...
        dirname = f"./.cache/privategpt/memories/{file.name}/"
